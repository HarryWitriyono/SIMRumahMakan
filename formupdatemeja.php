...
<html lang="en">
<head>
  <title>SIM Rumah Makan - Form Update Meja</title>
  <meta charset="utf-8">
...
<div class="container mt-3">
  <h2>Form Update Meja</h2>
<form method="post" action="updatemeja.php">
  <div class="form-group row">
    <label for="NomorMeja" class="col-4 col-form-label">Nomor Meja</label> 
    <div class="col-8">
      <input id="NomorMeja" name="NomorMeja" type="text" required="required" class="form-control">
    </div>
  </div>
  <div class="form-group row">
